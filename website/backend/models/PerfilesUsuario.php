...
class PerfilesUsuario
{
    ...
    {
        $db = new \Common\Database;
        $db->query("SELECT perfil_medico.id_perfil_medico ,perfil_medico.nombres, perfil_medico.apellidos, date_part('year',age(perfil_medico.fecha_nacimiento)), pais.nombre, perfil_medico.ciudad, perfil_medico.foto, perfil_medico.uid
