            ...
            <form class="col-12 bg-white rounded" method="post" action="" id="account-form">
                ...
                <div class="row">
                    <div class="col-12 col-md-6 mt-2 mx-auto">
                        <div class="col-12">
                            <label class="text-help text-settings-tfname" for="inputEmail">Email</label>
                ...
                <div class="row">
                    <div class="col-12 col-md-6 mt-4">
                        <div class="col-12">
                            <label class="text-help text-settings-tfname" for="first-name">Account owner medical profile</label>
                            <div class="input-group mb-4">
            ...
            <form class="col-12 bg-white rounded" method="post" action="" id="password-form">
                ...
                <div class="row">
                    <div class="col-12 col-md-6 mt-2 ml-auto">
                        <div class="col-12">
                            <label class="text-help text-settings-tfname" for="inputNewPasswordR">Re-enter new password</label>
                            <div class="input-group mb-4">
            ...
            <div class="col-12 bg-white rounded">
                <div class="row mb-md-5 mb-3">
                    <div class="col-8 my-4 mx-auto">
                        <div class="col-11">
                            <p class="text-help text-settings-da mb-0">Once you delete your account, it can't be recovered.</p>
                        </div>
                    </div>
