...
<div id="dashboard">
    <div v-if="showModal" class="container mt-5" id="dashboard">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="perfiles" role="tabpanel">
                ...
                <div class="card profile-card my-5 text-center text-sm-left" v-for="(item, index) in show"
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-sm-9">
                            <div class="card-body">
                                <h5 class="card-title text-regular" v-if="item.nombres === null">Complete su nombre.
                                </h5>
                                ...
                                <p class="card-text" v-else>{{item.date_part }} Años, {{item.nombre}}, {{item.ciudad}}
                                </p>
                                <div class="d-flex flex-column d-sm-block">
                                    <a @click="redirectToEdit(item.id_perfil_medico)"
                                        class="color-text text-link mr-4 mb-3" style="cursor: pointer;">
                                    ...
                                    <div class="dropdown-menu profile-more-options"
                                        aria-labelledby="dropdownMenuOffset">
                                        <a @click="imrpCode(item.uid, item.nombres, item.apellidos, item.date_part, item.ciudad)" class="dropdown-item mb-1" href="#"
                                            type="button" class="btn btn-primary" data-toggle="modal"
                                            data-target="#compartirQr"><i class="far fa-address-card mr-2"></i>
                                            Tarjeta QR</a>
                                        <a class="dropdown-item mb-1" href="#"><i
                                                class="far fa-arrow-alt-down mr-2"></i>
                                            Descargar PDF</a>
                                        <a @click="getShares('id_perfil_medico', item.id_perfil_medico)"
                                            class="dropdown-item mb-1" href="#" type="button" class="btn btn-primary"
                                            data-toggle="modal" data-target="#compartirUsuarios"><i
                                                class="far fa-share-square mr-2"></i> Compartir</a>
                                        <a class="dropdown-item mb-1" href="#"><i class="fas fa-history mr-2"></i></i>
                                            Ver
                                            actividad</a>
                                        <a @click="encapsulateId('id_perfil_medico', item.id_perfil_medico)"
                                            class="dropdown-item" href="#" type="button" class="btn btn-primary"
                                            data-toggle="modal" data-target="#eliminarperfil">
                ...
                <div class="d-flex justify-content-between" v-else>
                    ...
                    <nav aria-label="...">
                        <ul class="pagination">
                            ...
                            <li class="page-item" v-show="pag * NUM_RESULTS / show.length < 1"
                                @click.prevent="pag += 1">
            ...
            <div class="tab-pane" id="compartidos" role="tabpanel">
                ...
                <div class="card profile-card my-5 text-center text-sm-left" v-for="(item, index) in ShowShared"
                ...
                <div class="d-flex justify-content-between" v-else>
                    ...
                    <nav aria-label="...">
                        <ul class="pagination">
                            ...
                            <li class="page-item" v-show="pagC * NUM_RESULTSC / ShowShared.length < 1"
        ...
        <div class="modal fade" ref="shareModal" id="compartirUsuarios" tabindex="-1" role="dialog"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Puedes compartir el perfil médico con una persona en específico: debe ser un usuario de la
                            plataforma.</p>
                        <p class="card-text"><small class="text-muted">Correo electrónico del usuario a
                                compartir</small>
                        </p>
                        <div class="input-group mb-4">
                            <input class="textfield" type="email" class="form-control" id="email"
                                aria-describedby="basic-addon3" ref="email">
                            <div class="line"></div>
                        </div>
                        <div class="d-flex row mb-4">
                            ...
                            <div class="col-3 text-right">
                                <button @click="shareProfileWith()" type="button" class="btn"
                                    style="font-weight: 600;color:black;border-color: #DDE3F0;">Invitar</button>
                            </div>
                        </div>
                        <div>
                            <p class="card-text" class="mb-3"><small class="text-muted">Gestiona quién tiene
                                    acceso</small></p>
                            <div :class="'overflow-auto' + upperSpace" style="height:130px; max-height:130px;">
                                <div class="d-flex justify-content-center" v-if="!sharedWith.length" v-html="loading">
                                </div>
                                <div v-else="sharedWith.length" v-cloak id="users"
                                    ...
                                    <i @click="deleteSharing('id_usuario', user.id_usuario)"
                                        class="far fa-trash mt-1 text-link" style="color: grey; cursor: pointer;"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer  border-0 d-flex justify-content-between">
                        <small class="text-muted"><a href="" style="text-decoration: none;font-weight: 600;color:grey"
                                data-dismiss="modal" data-toggle="modal" data-target="#exampleModalCenter">Compartir
                                enlace</a></small>
        ...
        <div class="modal fade" id="eliminarperfil" tabindex="-1" role="dialog"
            aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header border-0">
                    ...
                    <div class="modal-footer border-0 d-flex justify-content-end">
                        <button @click="deleteProfile('Own')" type="button" class="btn"
        ...
        <div class="modal fade" id="eliminarperfilcompartido" tabindex="-1" role="dialog"
            aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header  border-0">
                    ...
                    <div class="modal-body">
                        <p>¿Estás seguro que quieres eliminar este perfil? Perderás el acceso para verlo, pero el perfil
                            seguirá disponible para el propietario.</p>
                    </div>
                    <div class="modal-footer  border-0 d-flex justify-content-end">
                        <button @click="deleteProfile('Shared')" type="button" class="btn"
                            style="font-weight: 600;color:black;border-color: #DDE3F0;">
                            {{deleteText}}</button>
                        <button type="button" class="btn btn-primary" style="font-weight: 600;"
                            data-dismiss="modal">Cancelar</button>
    ...
    <div data-backdrop="static" class="modal fade" ref="shareModal" id="compartirQr" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header  border-0">
                    <!--<h5 class="text-header-modal" id="exampleModalCenterTitle">Compartir tu codigo QR</h5>-->
                    <button v-if="showButtonModal" @click="showModal = true" type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body d-flex justify-content-center">
                    <div>
                        <img style="width: 100%; margin: auto; height: 30px"
                            src="<?= HOME_PATH ?>resources/images/for-light-bg.svg" width="150" height="70"
                            alt="Emergencia.id">
                        <small class="d-flex justify-content-center mt-2">Puedes enviar este codigo QR para escanear tu
                            información</small>
                        <span style="color: #2F8DEB" class="d-flex justify-content-center mt-2">{{nameModal}}</span>
                        <small class="d-flex justify-content-center mt-2">{{edadModal}} años, {{ciudadModal}}</small>
                        <img :src="srcImage" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="modal-footer border-0 d-flex justify-content-between">
                    <small class="text-muted"><a href="" style="text-decoration: none;font-weight: 600;color:grey"
                            data-dismiss="modal" data-toggle="modal" data-target="#exampleModalCenter"></a></small>
                    <button v-if="showButtonModal" @click="dowloadQR" type="button" class="btn btn-primary" style="font-weight: 600;">Descargar
                        codigo</button>
                </div>
            </div>
        </div>
