...
<div id="dashboard">
    <div class="container mt-5" id="dashboard">
        ...
        <div class="nav d-flex d-md-block line nav-profiles" role="tablist">
            <a class="navbar-brand profile-option text-link active" data-toggle="tab" href="#perfiles">My profiles</a>
            <a class="navbar-brand profile-option text-link" data-toggle="tab" href="#compartidos">Shared with me</a>
            <!-- btn escritorio -->
            ...
            <div class="tab-pane active" id="perfiles" role="tabpanel">
                ...
                <div class="card profile-card my-5 text-center text-sm-left" v-for="(item, index) in show" v-show="(pag - 1) * NUM_RESULTS <= index  && pag * NUM_RESULTS > index">
                    <div class="row no-gutters">
                        ...
                        <div class="col-sm-9">
                            <div class="card-body">
                                <h5 class="card-title text-regular" v-if="item.nombres === null">Complete your name.</h5>
                                ...
                                <p class="card-text" v-else>{{item.date_part }} Years, {{item.nombre}}, {{item.ciudad}}</p>
                                <div class="d-flex flex-column d-sm-block">
                                    ...
                                    <div class="dropdown-menu profile-more-options" aria-labelledby="dropdownMenuOffset">
                                        ...
                                        <a class="dropdown-item mb-1" href="#"><i class="far fa-arrow-alt-down mr-2"></i>
                                            Download PDF</a>
                                        <a @click="getShares('id_perfil_medico', item.id_perfil_medico)" class="dropdown-item mb-1" href="#" type="button" class="btn btn-primary" data-toggle="modal" data-target="#compartirUsuarios"><i class="far fa-share-square mr-2"></i> Share</a>
                                        <a class="dropdown-item mb-1" href="#"><i class="fas fa-history mr-2"></i></i> See activity </a>
                    ...
                    <nav aria-label="...">
                        <ul class="pagination">
                            <li class="page-item" v-show="pag != 1" @click.prevent="pag -= 1">
                                <a class="button button--small" href="#">Back</a>
                            </li>

                            <li class="page-item" v-show="pag * NUM_RESULTS / show.length < 1" @click.prevent="pag += 1">
                                <a class="button button--small" href="#">Next</a>
                            </li>
                        </ul>
                    </nav>
                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-column d-sm-block">
                                    ...
                                    <div class="dropdown-menu profile-more-options" aria-labelledby="dropdownMenuOffset">
                                        <a class="dropdown-item mb-1" href="#"><i class="far fa-arrow-alt-down mr-2"></i>
                                            Download PDF</a>
                                        <a @click="encapsulateId('id_perfil_medico', item.id_perfil_medico)" class="dropdown-item" href="#" type="button" class="btn btn-primary" data-toggle="modal" data-target="#eliminarperfilcompartido"><i class="far fa-trash mr-2"></i> Delete</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal fade" ref="shareModal" id="compartirUsuarios" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header  border-0">
                        <h5 class="text-header-modal" id="exampleModalCenterTitle">Share profile</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <p>You can share the medical profile with a specific person: it must be a user of the platform.</p>
                        <p class="card-text"><small class="text-muted">User's email to be shared</small>
                        </p>
                        <div class="input-group mb-4">
                        ...
                        <div class="d-flex row mb-4">
                            ...
                            <div class="col-3 text-right">
                                <button @click="shareProfileWith()" type="button" class="btn" style="font-weight: 600;color:black;border-color: #DDE3F0;">Invite</button>
                            </div>
                        </div>
                        <div>
                            <p class="card-text" class="mb-3"><small class="text-muted">Manage who has access</small></p>
                    ...
                    <div class="modal-footer  border-0 d-flex justify-content-between">
                        <small class="text-muted"><a href="" style="text-decoration: none;font-weight: 600;color:grey" data-dismiss="modal" data-toggle="modal" data-target="#exampleModalCenter">Share link</a></small>
                        <button type="button" class="btn btn-primary" style="font-weight: 600;" data-dismiss="modal">Accept</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="eliminarperfil" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header border-0">
                    <h5 class="text-header-modal" id="exampleModalCenterTitle">Delete profile</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <p>Are you sure you want to delete this profile? Once deleted you cannot recover it</p>
                </div>
    ...
    <div class="modal fade" id="eliminarperfilcompartido" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header  border-0">
                    <h5 class="text-header-modal" id="exampleModalCenterTitle">Delete shared profile</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <p>Are you sure you want to delete this profile? You will lose access to view it, but the profile will still be available to the owner.</p>
                </div>
                <div class="modal-footer  border-0 d-flex justify-content-end">
