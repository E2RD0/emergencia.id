...
<body class="app">
    <nav class="navbar navbar-light bg-white">
        <img class="ml-3" src="<?= HOME_PATH ?>resources/images/for-light-bg.svg" width="150" height="70"
            alt="Emergencia.id">
        <div class="navbar-items d-flex align-items-center mr-0 mr-sm-3">
            <a href="<?= HOME_PATH ?>app/user/profiles" class="color-text text-link mr-lg-5">My profiles</a>
            <div class="dropdown dropdown-nav-options">
                <?php
                        ...
                        if (isset($_SESSION['user_id'])) {
                         ...
                         ?>
                <a href="#" id="nombreUsuario" class="font-size-regular btn dropdown-toggle shadow-none" type="button"
                    id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true"
                    aria-expanded="false"><?= $nombre?></a>
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item font-size-regular" href="<?= HOME_PATH ?>app/user/settings">Account
                        settings</a>
                    <a class="dropdown-item font-size-regular" href="#" onclick="logout()">Sign off</a>
                </div>
            </div>
        </div>
    </nav>
